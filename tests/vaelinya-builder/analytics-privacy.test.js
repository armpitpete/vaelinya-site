...
for (const [name, path] of [
  ['shared layout', layoutPath],
  ['standalone Builder', builderPath],
]) {
  test(`${name} exposes the analytics disclosure and objection control`, async () => {
    ...
    assert.match(source, /\/scripts\/analytics-privacy\.js/);
